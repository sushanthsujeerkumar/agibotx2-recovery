...
| Python regression suite | 16 passed; TorchScript deprecation warnings only |
...
After cleanup, the remaining 16 Python tests, 28 ROS tests, five assessment episodes and fresh ROS integration checks passed again. Seven Python tests and two ROS cases belonged only to removed experimental controllers. Their earlier test records remain in Git history.
