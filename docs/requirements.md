...
This maps the official HRS take-home requirements to the delivered project. The original recovery criterion and the subsequently added clean-stance criterion are reported separately. The posture limitation remains explicit.
...
| Floating base, flat floor, collisions, joint/actuator limits | `assets/x2/scene.xml`, `src/x2_recovery/common.py`, [model validation](../assets/x2/model_validation.json) |
...
| Failures and limitations explained | [RESULTS.md](../RESULTS.md): initial 0/5, selected 5/5, inward/edge-supported bracing and additional clean-stance 0/5 |
